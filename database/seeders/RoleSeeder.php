...
class RoleSeeder extends Seeder
{
    ...
    {
        $roles = [
            ['role_code' => 'ADMIN', 'role_name' => 'Giám đốc / Quản trị viên', 'description' => 'Quản lý chung, cấu hình hệ thống, phân quyền và xem báo cáo tổng quan.'],
            ...
            ['role_code' => 'FIELD', 'role_name' => 'Nhân viên hiện trường', 'description' => 'Xử lý hiện trường, cập nhật trạng thái đơn hàng và tải chứng từ.'],
